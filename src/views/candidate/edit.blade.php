                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="selectItem">
                                                    <input type="text" class="form-control" name="candidate_name"
                                                        id="candi_name" value="{{isset($candidate->name)?$candidate->name:''}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="selectItem">
                                                    <input type="text" class="form-control" name="candidate_mobile"
                                                        id="candi_mobile" value="{{isset($candidate->phone)?$candidate->phone:''}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="selectItem">
                                                    <input type="email" class="form-control" name="candidate_email"
                                                        id="candi_email" value="{{isset($candidate->email)?$candidate->email:''}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="selectItem">
                                                    <input type="text" class="form-control" name="candidate_resume_url"
                                                        id="candi_resume_url" value="{{isset($candidate->resume_url)?$candidate->resume_url:''}}">
                                                </div>
                                            </div>
                                        </div>
